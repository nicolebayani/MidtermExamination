...
<head>
  ...
  <title>Teacher Dashboard - Learnify Portal</title>
  ...
  <div class="side-panel">
    <div>
      ...
      <ul class="nav nav-pills flex-column mb-auto">
        ...
        <li>
          <a class="nav-link" href="<?= site_url('announcements') ?>"><i class="fas fa-bullhorn"></i> Announcements</a>
        </li>
        <li>
          <a class="nav-link" href="#"><i class="fas fa-book"></i> Grades</a>
        </li>
        <li>
